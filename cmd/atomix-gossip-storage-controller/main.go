...
import (
	...
	storagev2beta1 "github.com/atomix/atomix-gossip-storage/pkg/controller/storage/v2beta1"

	storagev1beta1 "github.com/atomix/atomix-gossip-storage/pkg/controller/storage/v2beta1"
	...
	"github.com/atomix/atomix-gossip-storage/pkg/apis"
...
func main() {
	...
	logf.SetLogger(logutil.NewControllerLogger("atomix", "controller", "gossip"))
